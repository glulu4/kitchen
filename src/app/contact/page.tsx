        ...
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            >
                {/* <div
                    ...
                    className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80b9ff] to-[#b5b5b5] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
                /> */}
            </div>
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Contact</h2>
                <p className="mt-2 text-lg/8 text-gray-600">Let us design your dream kitchen</p>
            </div>
